...
const marqueeItems = [
  'Education', 'Career', 'Fitness', 'Learning Techniques', 'NLP Master Training', 'Sports Psychology',
  'Education', 'Career', 'Fitness', 'Learning Techniques', 'NLP Master Training', 'Sports Psychology',
];
      ...
      <div className="hero__body">
        ...
        <div className="sidebar">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px' }}>
            ...
            <svg width="12" height="36" viewBox="0 0 12 36" style={{ color: 'rgba(255,255,255,0.35)', marginTop: '4px' }}>
        ...
        <div className="hero__center">
          <p className="hero__eyebrow">Founder &amp; Director — Mr. Asish Kumar Das</p>
          <div className="hero__tag-line">
            <span className="hero__tag">Pan India Online &amp; Offline&nbsp;↗</span>
            <div className="hero__tag-divider" />
          </div>

          <h1 className="hero__heading">
            Know exactly how your<br />Subconscious Mind Works
          </h1>
          <p className="hero__subheading">Manifest every dream into a reality</p>

          <div className="hero__cta-row">
            {/* Squiggle */}
            <svg width="48" height="48" viewBox="0 0 80 80" fill="none" style={{ color: 'rgba(255,255,255,0.55)', flexShrink: 0, marginRight: '-8px' }}>
            ...
            <button className="play-btn" aria-label="Watch work process">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="white">
                <polygon points="5,3 19,12 5,21" />
              </svg>
            </button>

            <p className="hero__cta-label">Free<br />Trial Class</p>
        ...
        <div className="hero__portrait">
          <img src="/matias.png" alt="Mr. Asish Kumar Das – Mind Mentor" />
        </div>
        ...
        <div className="sidebar">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', alignItems: 'center' }}>
            {[
              ...
              <a key={i} href="#" style={{ color: 'rgba(255,255,255,0.45)', display: 'flex', alignItems: 'center', transition: 'color 0.2s' }}
